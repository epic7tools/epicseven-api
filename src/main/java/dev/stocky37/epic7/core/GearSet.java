...
import static dev.stocky37.epic7.core.Stat.ATK;
...
import static dev.stocky37.epic7.core.Stat.DEF;
...
import static dev.stocky37.epic7.core.Stat.SPD;

public enum GearSet {
	ATTACK("attack", "Attack Set", ATK, new BigDecimal("0.35"), 4),
	CRITICAL	("critical", "Critical Set", CHC, new BigDecimal("0.12"), 2),
	HEALTH("health", "Health Set", ATK, new BigDecimal("0.15"), 2),
	LIFESTEAL("lifesteal", "Lifesteal Set", LS, new BigDecimal("0.2"), 4),
	HIT("hit", "Hit Set", EFF, new BigDecimal("0.2"), 2),
	SPEED("speed", "Speed Set", SPD, new BigDecimal("0.25"), 4),
	...
	DEFENSE("defense", "Defense Set", DEF, new BigDecimal("0.15"), 2),
